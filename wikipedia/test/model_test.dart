...
// Mudamos aqui para incluir wikipedia/ no início dos caminhos:
const String dartLangSummaryJson = 'wikipedia/test/test_data/dart_lang_summary.json';
const String catExtractJson = 'wikipedia/test/test_data/cat_extract.json';
const String openSearchResponse = 'wikipedia/test/test_data/open_search_response.json';
