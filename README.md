...
.Compreender dados JSON.

.Utilizar e compreender Future, Await e Async.

.Compreender requisições HTTP

.Trabalhar e compreender bibliotecas.
...
Conteúdos trabalhados no Learn Flutter/Dart:
 
- Crie Seu Primeiro Aplicativo (Realizado)
- Adicione interatividade ao seu aplicativo (Realizado)
